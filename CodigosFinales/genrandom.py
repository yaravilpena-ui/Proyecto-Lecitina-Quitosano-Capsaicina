"""
Crea configuración random de agua (W) y lecitina (L1–L2–L3–L3–L3 )
Tipos de cuenta: 1=W, 2=L1, 3=L2, 4=L3
Ángulos: k25.0, θ0=170°
"""
...
# ========== PARÁMETROS ==========
N_lip = 3929 #Se modifica de acuerdo a la concentracion
rho_global = 3.0
N_total = 150000
N_lip_beads = 5 * N_lip
...
ks = 50.0
theta_deg = 170.0
bend_angle = math.radians(180.0 - theta_deg)   

atoms = []      # (id, mol, tipo, q, x, y, z)
bonds = []      # (tipo_enlace, id1, id2)
angles = []     # (tipo_angulo, id1, id2, id3)
...
print("Archivo 'data.random' creado.")
